...
namespace DatabaseBenchmark.Tests.Databases
{
    public class MonetDbQueryBuilderTests
    {
        ...
        public void BuildQueryNoArguments()
        {
            ...
            var builder = new MonetDbQueryBuilder(SampleInputs.Table, SampleInputs.NoArgumentsQuery, parametersBuilder, null);
        ...
        public void BuildQueryAllArguments()
        {
            ...
            var parametersBuilder = new SqlParametersBuilder();
            var builder = new MonetDbQueryBuilder(SampleInputs.Table, query, parametersBuilder, null);
