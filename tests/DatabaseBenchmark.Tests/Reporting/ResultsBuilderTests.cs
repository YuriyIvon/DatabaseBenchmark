...
namespace DatabaseBenchmark.Tests.Reporting
{
    public class ResultsBuilderTests
    {
        ...
        public void BuildResults()
        {
            ...
            metrics.Metrics.Add(new Metric(currentTime.AddSeconds(-1), currentTime));
            metrics.Metrics.Add(new Metric(currentTime.AddSeconds(-2), currentTime));
            metrics.Metrics.Add(new Metric(currentTime.AddSeconds(-3), currentTime));
