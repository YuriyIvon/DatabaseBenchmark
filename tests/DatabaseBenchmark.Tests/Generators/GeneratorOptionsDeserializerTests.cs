...
namespace DatabaseBenchmark.Tests.Generators
{
    public class GeneratorOptionsDeserializerTests
    {
        ...
        [
            ...
            ["{\"Type\":\"DateTime\", \"MinValue\":\"2012-01-02T12:12:12\", \"MaxValue\":\"2020-03-04T13:14:15\", \"Direction\":\"Ascending\", \"Delta\":\"03:00:00\", \"RandomizeDelta\":true}",
                new DateTimeGeneratorOptions { MinValue = new DateTime(2012, 1, 2, 12, 12, 12), MaxValue = new DateTime(2020, 3, 4, 13, 14, 15), Direction = Direction.Ascending, Delta = TimeSpan.FromHours(3), RandomizeDelta = true }],
            ...
            ["{\"Type\":\"Float\", \"MinValue\":100, \"MaxValue\":1000, \"Direction\":\"Ascending\", \"Delta\":3, \"RandomizeDelta\":true}",
                new FloatGeneratorOptions { MinValue = 100, MaxValue = 1000, Direction = Direction.Ascending, Delta = 3, RandomizeDelta = true }],
            ["{\"Type\":\"ColumnItem\", \"TableName\":\"table\", \"ColumnName\":\"column\", \"ColumnType\":\"String\"}",
                new ColumnItemGeneratorOptions { TableName = "table", ColumnName = "column", ColumnType = ColumnType.String }],
            ["{\"Type\":\"ColumnIterator\", \"TableName\":\"table\", \"ColumnName\":\"column\", \"ColumnType\":\"String\"}",
                new ColumnIteratorGeneratorOptions { TableName = "table", ColumnName = "column", ColumnType = ColumnType.String }],
            ["{\"Type\":\"Guid\"}",
                new GuidGeneratorOptions() ],
            ["{\"Type\":\"Integer\", \"MinValue\":100, \"MaxValue\":1000, \"Direction\":\"Ascending\", \"Delta\":3, \"RandomizeDelta\":true}",
                new IntegerGeneratorOptions { MinValue = 100, MaxValue = 1000, Direction = Direction.Ascending, Delta = 3, RandomizeDelta = true }],
            ...
            ["{\"Type\":\"ListIterator\", \"Items\":[\"one\", \"two\", \"three\"]}",
                new ListIteratorGeneratorOptions { Items = ["one", "two", "three"] }],
