...
namespace DatabaseBenchmark.Tests.Generators
{
    public class GeneratorOptionsDeserializerTests
    {
        ...
        [
            ...
            ["{\"Type\":\"ForeignKey\", \"TableName\":\"table\", \"ColumnName\":\"column\", \"ColumnType\":\"String\"}",
               new ForeignKeyGeneratorOptions { TableName = "table", ColumnName = "column", ColumnType = ColumnType.String }],
            ["{\"Type\":\"Guid\"}",
